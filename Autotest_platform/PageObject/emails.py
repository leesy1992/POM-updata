...
def send_email_reports(splitResult_id,receiver='charles.li@ihr360.com,bryan.chen@ihr360.com', name="",subject=" UI自动化测试报告", bodyText="UI测试报告地址： ",status="【成功】"):
    ...
    body="<p>{}<a href='http://192.168.20.23:8000/admin/results/{}'>http://ui.ihr360.com/admin/results/{} </a>    请查收，谢谢！</p>".format(bodyText,splitResult_id,splitResult_id)#线上地址
