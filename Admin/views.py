...
def testcase_edit(request, testcase_id):
    return render(request, "page/6-2编辑测试用例.html", {"testcaseId": testcase_id})
...
# @login_required
def result_see_nologin(request, result_id):
    return render(request, "page/查看测试结果.html", {"id": result_id})
